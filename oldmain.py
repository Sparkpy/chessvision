...
def drawGrid(img, color=(0,0,0), thickness=2):
...
while not board.is_game_over():
    ...
    ret, difference = cv.threshold(boardDifference(oldBoard, newBoard, 3), 30, 255, cv.THRESH_BINARY)

    cv.imshow("Difference", drawGrid(difference, (255, 255, 255), 1))
